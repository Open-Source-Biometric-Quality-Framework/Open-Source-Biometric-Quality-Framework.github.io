...
+ [OBQE](https://docs.openbq.io/modality/face.html#obqe)
+ [OFIQ](https://docs.openbq.io/modality/face.html#ofiq)
  - [ISO/IEC 29794-5](https://www.iso.org/standard/81005.html)
+ [BIQT](https://docs.openbq.io/modality/face.html#biqt)

***

<a name="obqe">
### OBQE (Open Biometric Quality Engine by open**bq**)
