...
For bqconnect CLI, if your input folder name has spaces, you need to add a escape character ("\\" in Linux), and enclose the path with quotation marks:
...
## I encountered permission issues when running bqconnect CLI in the terminal. What should I do?
...
<!-- ## bqconnect CLI see error related to ray worker died.
...
{: .highlight }
> Let us know if you have question or new idea in the discussion board, or reach out to [us](https://docs.openbq.io/about/#about-us)!
